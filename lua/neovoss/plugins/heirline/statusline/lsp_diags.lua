...
local Diagnostics = require("neovoss.plugins.heirline.statusline.diagnostics")
local LspActive = require("neovoss.plugins.heirline.statusline.lsp")
...
local LspDiagnostics = {
	...
	init = function(self)
		...
		self.show_diagnostics = self.has_diagnostics and ((self.errors > 0) or (self.warnings > 0) or (self.hints > 0) or (self.info > 0))
	end,
	{
